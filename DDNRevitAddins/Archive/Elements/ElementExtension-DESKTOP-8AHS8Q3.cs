...
namespace DDNRevitAddins.Archive.Elements
{
    public static class ElementExtension
    {
        ...
        public static Group ExtGetGroup(this Element element)
        {
            Element group = element.ExtDbDocument().ExtGetElement(element.ExtGetGroupId());
            if (group != null) return group as Group;
            return null;
        }

        public static ElementId ExtGetGroupId(this Element element)
        {
